  ...
  return function (e) {
    ...
    e.exports = function (e, t, i, n, r) {
      ...
      if (r ? (l = function (e) {
        ...
        var p = u.functional, f = p ? u.render : u.beforeCreate;
    ...
    var l = i(82), p = {}, f = u && (document.head || document.getElementsByTagName("head")[0]), d = null, c = 0,
      h = !1, A = function () {
    ...
    var i = Object.prototype, n = Array.prototype, r = i.toString, o = function (e) {
      ...
      uid: function () {
      ...
      }, isPlainObject: a, isFunction: o, isArray: s, isObject: function (e) {
        return Object(e) === e
      }, isString: function (e) {
        ...
        if (l.isDefined(e.length)) for (var n = 0, r = e.length; n < r && !1 !== t.call(i, e[n], n, e); n++) ; else for (var o in e) if (!1 === t.call(i, e[o], o, e)) break
      }, evalOpts: function (e, t) {
        return l.isFunction(e) && (t = l.toArray(arguments), e = e.apply(null, t.slice(1))), e
      }, extend: function () {
        var e, t, i, n, r, u, p = arguments[0] || {}, f = 1, d = arguments.length, c = !1;
        for ("boolean" == typeof p && (c = p, p = arguments[1] || {}, f++), "object" == typeof p || o(p) || (p = {}), f === d && (p = this, f--); f < d; f++) if (null != (e = arguments[f])) for (t in e) i = p[t], n = e[t], p !== n && (c && n && (a(n) || (r = s(n))) ? (r ? (r = !1, u = i && s(i) ? i : []) : u = i && a(i) ? i : {}, p[t] = l.extend(c, u, n)) : void 0 !== n && (p[t] = n));
        return p
        ...
        Object.defineProperty(e, t, {enumerable: !1, configurable: !0, writable: !0, value: i})
      }
    };
    e.exports = l
  }, function (e, t, i) {
    var n, r, o;
    !function (s, a) {
      r = [t, i(6)], n = a, void 0 !== (o = "function" == typeof n ? n.apply(t, r) : n) && (e.exports = o)
    }(0, function (e, t) {
      "use strict";
      Object.defineProperty(e, "__esModule", {value: !0}), e.supportMixin = e.uploaderMixin = void 0;
      e.uploaderMixin = {
        mounted: function () {
          this.uploader = (0, t.getUploader)(this)
        }
      }, e.supportMixin = {
        data: function () {
          return {support: !0}
    ...
    r.extend(n.prototype, {
      _event: function (e, t) {
        ...
        var t = r.evalOpts(this.uploader.opts.testMethod, this.file, this), i = this.prepareXhrRequest(t, !0);
        this.xhr.send(i);
        var n = this
        ...
        function t(e) {
          var t = u.status();
          if (t === o.SUCCESS || t === o.ERROR) delete this.data, u._event(t, u.message()), t === o.ERROR && u.uploader.uploadNextChunk(); else {
        ...
        var i = this.uploader.opts.preprocess, n = this.uploader.opts.readFileFn;
        ...
        return 1 === this.readState ? o.READING : this.pendingRetry || 1 === this.preprocessState ? o.UPLOADING : this.xhr ? this.xhr.readyState < 4 ? o.UPLOADING : this.uploader.opts.successStatuses.indexOf(this.xhr.status) > -1 ? o.SUCCESS : this.uploader.opts.permanentErrors.indexOf(this.xhr.status) > -1 || !e && this.retries >= this.uploader.opts.maxChunkRetries ? o.ERROR : (this.abort(), o.PENDING) : o.PENDING
      }, message: function () {
        ...
        var s = r.evalOpts(this.uploader.opts.target, this.file, this, t), a = null;
        if ("GET" === e || "octet" === i) {
          var u = [];
          ...
          a.append(t, e)
        }), a.append(this.uploader.opts.fileParameterName, n, this.file.name);
    ...
    function n(e) {
      this.support = l, this.support && (this.supportDirectory = p, r.defineNonEnumerable(this, "filePaths", {}), this.opts = r.extend({}, n.defaults, e || {}), s.call(this, this))
    }

    var r = i(4), o = i(66), s = i(67), a = i(20), u = window.navigator.msPointerEnabled, l = function () {
      var e = "slice", t = r.isDefined(window.File) && r.isDefined(window.Blob) && r.isDefined(window.FileList),
        i = null;
    ...
    n.version = "__VERSION__", n.defaults = {
      ...
      constructor: n,
      _trigger: function (e) {
        var t = r.toArray(arguments), i = !this.trigger.apply(this, arguments);
      ...
      uploadNextChunk: function (e) {
        var t = !1, i = a.STATUS.PENDING, n = this.uploader.opts.checkChunkUploadedByResponse;
        ...
        }), o || e || this._triggerAsync("complete"), o
      },
      upload: function (e) {
      ...
      _shouldUploadNext: function () {
        var e = 0, t = !0, i = this.opts.simultaneousUploads, n = a.STATUS.UPLOADING;
      ...
      onDrop: function (e) {
        this.opts.onDropStopPropagation && e.stopPropagation(), e.preventDefault(), this._parseDataTransfer(e.dataTransfer, e)
      },
    ...
    var n, r, o;
    !function (s, a) {
      r = [e, t, i(22), i(12), i(13), i(16), i(15), i(14), i(3)], n = a, void 0 !== (o = "function" == typeof n ? n.apply(t, r) : n) && (e.exports = o)
      ...
      Object.defineProperty(t, "__esModule", {value: !0});
      var f = l(i), d = l(n), c = l(r), h = l(o), A = l(s), v = l(a), g = l(u), C = {
        version: "0.4.6",
        install: p,
        Uploader: f.default,
    ...
    var n, r, o;
    !function (s, a) {
      r = [e, t, i(5)], n = a, void 0 !== (o = "function" == typeof n ? n.apply(t, r) : n) && (e.exports = o)
    }(0, function (e, t, i) {
      "use strict";
      Object.defineProperty(t, "__esModule", {value: !0});
      t.default = {
        ...
        mounted: function () {
          ...
          this.$nextTick(function () {
            e.uploader.assignBrowse(e.$refs.btn, e.directory, e.single, e.attrs)
          })
        }
      }, e.exports = t.default
    })
    ...
    !function (s, a) {
      ...
      Object.defineProperty(t, "__esModule", {value: !0});
      t.default = {
        name: "uploader-drop", mixins: [i.uploaderMixin, i.supportMixin], data: function () {
          return {dropClass: ""}
        }, methods: {
    ...
    var n, r, o;
    !function (s, a) {
      r = [e, t, i(32), i(21), i(23), i(6)], n = a, void 0 !== (o = "function" == typeof n ? n.apply(t, r) : n) && (e.exports = o)
      ...
      Object.defineProperty(t, "__esModule", {value: !0});
      var a = s(i), u = s(n), l = s(r);
      t.default = {
        name: "uploader-file", props: {
          file: {
            type: Object, default: function () {
              return {}
            }
          ...
          fileCategory: function () {
            var e = this.extension, t = this.file.isFolder, i = t ? "folder" : "unknown",
              n = this.file.uploader.opts.categoryMap, r = n || {
            ...
            var e = Math.floor(100 * this.progress), t = "translateX(" + Math.floor(e - 100) + "%)";
            ...
            var e = this.isUploading, t = this.isComplete, i = this.error, n = this.paused;
            return t ? "success" : i ? "error" : e ? "uploading" : n ? "paused" : "waiting"
          }, statusText: function () {
            var e = this.status;
            return this.file.uploader.fileStatusText[e] || e
          }, formatedTimeRemaining: function () {
            var e = this.timeRemaining, t = this.file;
            if (e === Number.POSITIVE_INFINITY || 0 === e) return "";
            var i = (0, o.secondsToStr)(e), n = t.uploader.opts.parseTimeRemaining;
            return n && (i = n(e, i)), i
          }
        }, watch: {
          status: function (e, t) {
          ...
          _actionCheck: function () {
            ...
            var i = t[0], n = t[1], r = this.list ? i : n;
            if (this.file === r) {
          ...
          }, _fileSuccess: function () {
            this._fileProgress(), this.error = !1, this.isComplete = !0, this.isUploading = !1
          }, _fileComplete: function () {
            this._fileSuccess()
          }, _fileError: function () {
            this._fileProgress(), this.error = !0, this.isComplete = !1, this.isUploading = !1
          }
        }, mounted: function () {
          var e = this, t = ["paused", "error", "averageSpeed", "currentSpeed"],
            i = ["isComplete", "isUploading", {key: "size", fn: "getSize"}, {
              key: "formatedSize",
              fn: "getFormatSize"
            }, {key: "uploadedSize", fn: "sizeUploaded"}, "progress", "timeRemaining", {
              key: "type",
              fn: "getType"
          ...
          var n = this._handlers = {}, r = function (t) {
            return n[t] = function () {
    ...
    !function (s, a) {
      ...
      t.default = {
        name: "uploader-files", computed: {
          files: function () {
            return this.$parent.files
          }
        }, components: {UploaderFile: n.default}
      }, e.exports = t.default
    })
  }, function (e, t, i) {
    var n, r, o;
    ...
    var n, r, o;
    !function (s, a) {
      r = [e, t, i(21), i(6), i(12), i(13), i(16), i(15), i(14), i(3)], n = a, void 0 !== (o = "function" == typeof n ? n.apply(t, r) : n) && (e.exports = o)
    }(0, function (e, t, i, n, r, o, s, a, u, l) {
      "use strict";
      ...
      Object.defineProperty(t, "__esModule", {value: !0});
      var f = p(i), d = p(r), c = p(o), h = p(s), A = p(a), v = p(u), g = p(l);
      t.default = {
        name: "uploader",
        props: {
          options: {
          ...
          }, autoStart: {type: Boolean, default: !0}, fileStatusText: {
            type: Object, default: function () {
              return {success: "success", error: "error", uploading: "uploading", paused: "paused", waiting: "waiting"}
            }
          }
        },
        data: function () {
          return {started: !1, files: [], fileList: []}
        },
        methods: {
          uploadStart: function () {
            ...
            if (this.$emit((0, n.kebabCase)("filesAdded"), e, t), e.ignored || t.ignored) return !1
            ...
            var r = t[0];
            "fileAdded" !== r && "filesAdded" !== r && (t[0] = (0, n.kebabCase)(r), this.$emit.apply(this, t))
          }
        },
        created: function () {
    ...
    e.exports = {default: i(33), __esModule: !0}
  }, function (e, t, i) {
    i(58), e.exports = i(7).Object.keys
  }, function (e, t) {
    e.exports = function (e) {
    ...
    var n = i(19), r = i(54), o = i(53);
    e.exports = function (e) {
      return function (t, i, s) {
        var a, u = n(t), l = r(u.length), p = o(s, l);
        if (e && i != i) {
          for (; l > p;) if ((a = u[p++]) != a) return !0
        } else for (; l > p; p++) if ((e || p in u) && u[p] === i) return e || p || 0;
        return !e && -1
      }
    }
  }, function (e, t) {
    ...
    var n = i(11), r = i(10).document, o = n(r) && n(r.createElement);
    e.exports = function (e) {
    ...
    var n = i(10), r = i(7), o = i(38), s = i(43), a = function (e, t, i) {
      var u, l, p, f = e & a.F, d = e & a.G, c = e & a.S, h = e & a.P, A = e & a.B, v = e & a.W,
        g = d ? r : r[t] || (r[t] = {}), C = g.prototype, m = d ? n : c ? n[t] : (n[t] || {}).prototype;
      d && (i = t);
    ...
    var n = i(35), r = i(44), o = i(56), s = Object.defineProperty;
    ...
    var n = i(42), r = i(19), o = i(36)(!1), s = i(51)("IE_PROTO");
    e.exports = function (e, t) {
      var i, a = r(e), u = 0, l = [];
    ...
    var n = i(41), r = i(7), o = i(9);
    e.exports = function (e, t) {
      var i = (r.Object || {})[e] || Object[e], s = {};
    ...
    var n = i(52)("keys"), r = i(57);
    e.exports = function (e) {
      return n[e] || (n[e] = r(e))
    }
  }, function (e, t, i) {
    var n = i(10), r = n["__core-js_shared__"] || (n["__core-js_shared__"] = {});
    e.exports = function (e) {
      return r[e] || (r[e] = {})
    }
  }, function (e, t, i) {
    var n = i(18), r = Math.max, o = Math.min;
    e.exports = function (e, t) {
      return e = n(e), e < 0 ? r(e + t, 0) : o(e, t)
    }
  }, function (e, t, i) {
    var n = i(18), r = Math.min;
    e.exports = function (e) {
    ...
    var n = i(4).each, r = {
      _eventData: null, on: function (e, t) {
        ...
        var t = this._eventData[e].slice.call(arguments, 1), i = !1;
    ...
    function r(e) {
      var t = [], i = e.split("/"), n = i.length, r = 1;
      if (i.splice(n - 1, 1), n--, i.length) for (; r <= n;) t.push(i.slice(0, r++).join("/") + "/");
      return t
    }
    ...
    o.extend(n.prototype, {
      _parseFile: function () {
        ...
        this._eachAccess(function (e) {
          ...
          if (e) {
            var t = this.uploader.opts.speedSmoothingFactor, i = this.sizeUploaded();
        ...
        var n = this.uploader, r = s.STATUS, o = this, a = this.getRoot(), u = function (t) {
        ...
        i ? (o.each(this.chunks, function (n) {
          !n.tested && i.call(this, n, e) && (n.xhr = t.xhr), n.tested = !0
        }, this), this._firstResponse ? this.uploader.uploadNextChunk() : (this._firstResponse = !0, this.uploader.upload(!0))) : this.uploader.uploadNextChunk()
      }, _error: function () {
        ...
        if (e.isFolder) for (; e.files.length;) {
    ...
    e.exports = {
      render: function () {
        var e = this, t = e.$createElement, i = e._self._c || t;
        return i("div", {staticClass: "uploader-list"}, [e._t("default", [i("ul", e._l(e.fileList, function (e) {
          return i("li", {key: e.id}, [i("uploader-file", {attrs: {file: e, list: !0}})], 1)
    ...
    e.exports = {
      render: function () {
        ...
        return i("div", {
        ...
        }), e._v(" "), i("div", {staticClass: "uploader-file-info"}, [i("div", {staticClass: "uploader-file-name"}, [i("i", {
          staticClass: "uploader-file-icon",
          attrs: {icon: e.fileCategory}
        }), e._v(e._s(e.file.name))]), e._v(" "), i("div", {staticClass: "uploader-file-size"}, [e._v(e._s(e.formatedSize))]), e._v(" "), i("div", {staticClass: "uploader-file-meta"}), e._v(" "), i("div", {staticClass: "uploader-file-status"}, [i("span", {
          directives: [{
            name: "show",
            rawName: "v-show",
        ...
        }, [i("span", [e._v(e._s(e.progressStyle.progress))]), e._v(" "), i("em", [e._v(e._s(e.formatedAverageSpeed))]), e._v(" "), i("i", [e._v(e._s(e.formatedTimeRemaining))])])]), e._v(" "), i("div", {staticClass: "uploader-file-actions"}, [i("span", {
          ...
          on: {click: e.retry}
        }), e._v(" "), i("span", {staticClass: "uploader-file-remove", on: {click: e.remove}})])])], {
          file: e.file,
          list: e.list,
          status: e.status,
          paused: e.paused,
    ...
    e.exports = {
      render: function () {
        var e = this, t = e.$createElement, i = e._self._c || t;
        return i("div", {staticClass: "uploader"}, [e._t("default", [i("uploader-unsupport"), e._v(" "), i("uploader-drop", [i("p", [e._v("Drop files here to upload or")]), e._v(" "), i("uploader-btn", [e._v("select files")]), e._v(" "), i("uploader-btn", {attrs: {directory: !0}}, [e._v("select folder")])], 1), e._v(" "), i("uploader-list")], {
          files: e.files,
          fileList: e.fileList,
          started: e.started
        })], 2)
      ...
      render: function () {
        ...
        return (e._self._c || t)("div", {
          directives: [{
            ...
            value: e.support,
            expression: "support"
          }], ref: "drop", staticClass: "uploader-drop", class: e.dropClass
        }, [e._t("default")], 2)
      }, staticRenderFns: []
    }
  }, function (e, t) {
    e.exports = {
      render: function () {
        var e = this, t = e.$createElement, i = e._self._c || t;
        return i("div", {staticClass: "uploader-files"}, [e._t("default", [i("ul", e._l(e.files, function (e) {
          return i("li", {key: e.id}, [i("uploader-file", {attrs: {file: e}})], 1)
        }))], {files: e.files})], 2)
      }, staticRenderFns: []
    }
  }, function (e, t) {
      ...
      render: function () {
        ...
        return (e._self._c || t)("span", {
          directives: [{
            ...
            value: e.support,
            expression: "support"
          }], ref: "btn", staticClass: "uploader-btn"
        }, [e._t("default")], 2)
      }, staticRenderFns: []
    }
  }, function (e, t, i) {
    ...
    e.exports = function (e, t) {
      for (var i = [], n = {}, r = 0; r < t.length; r++) {
        var o = t[r], s = o[0], a = o[1], u = o[2], l = o[3], p = {id: e + ":" + r, css: a, media: u, sourceMap: l};
